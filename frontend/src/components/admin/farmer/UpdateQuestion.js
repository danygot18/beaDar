...
const FUpdateQuestion = () => {
  ...
  useEffect(() => {
    const fetchQuestion = async () => {
      try {
        const response = await axios.get(`/api/v1/fquestions/${id}`);
...
export default FUpdateQuestion;