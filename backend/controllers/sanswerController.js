const Answer = require('../models/sanswer');
const Question = require('../models/sellerQuestions'); // Fix the import statement
const { validationResult } = require('express-validator');
const mongoose = require('mongoose');

const SanswerController = {
...
module.exports = SanswerController;